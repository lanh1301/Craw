...
import { router } from './routes_msct.js'
import $ from 'jquery';
const crawler = new CheerioCrawler({
    ...
    maxRequestsPerCrawl: 50, // Stop crawling after several pages
...
// await crawler.run([
//     'https://masocongty.vn/search?name=',
// ])


await crawler.run([
    'https://masocongty.vn/search?name="Công Ty Tnhh Goldmark Oakham"&by=cvn&pro=79',
])
